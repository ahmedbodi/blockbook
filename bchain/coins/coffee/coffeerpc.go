...
// coffeeRPC is an interface to JSON-RPC bitcoind service.
type coffeeRPC struct {
	*btc.BitcoinRPC
    BitcoinGetChainInfo func() (*bchain.ChainInfo, error)
}

// NewcoffeeRPC returns new coffeeRPC instance.
func NewcoffeeRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes coffeeRPC instance.
func (b *coffeeRPC) Initialize() error {
	...
	b.Parser = NewcoffeeParser(params, b.ChainConfig)
...
type ResGetInfo struct {
	...
	Result struct {
        ...
        ZerocoinSupply  bchain.ZCdenoms    `json:"zcoffeesupply"`
	} `json:"result"`
}
...
func (b *coffeeRPC) GetNextSuperBlock(nHeight int) int {
...
func (b *coffeeRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *coffeeRPC) Findzcserial(serialHex string) (string, error) {
