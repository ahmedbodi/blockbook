...
// pesoRPC is an interface to JSON-RPC bitcoind service.
type pesoRPC struct {
	*btc.BitcoinRPC
    BitcoinGetChainInfo func() (*bchain.ChainInfo, error)
}

// NewpesoRPC returns new pesoRPC instance.
func NewpesoRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes pesoRPC instance.
func (b *pesoRPC) Initialize() error {
	...
	b.Parser = NewpesoParser(params, b.ChainConfig)
...
type ResGetInfo struct {
	...
	Result struct {
        ...
        ZerocoinSupply  bchain.ZCdenoms    `json:"zpesosupply"`
	} `json:"result"`
}
...
func (b *pesoRPC) GetNextSuperBlock(nHeight int) int {
...
func (b *pesoRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *pesoRPC) Findzcserial(serialHex string) (string, error) {
